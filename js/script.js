...
let btn_pet = document.getElementById("btn_pet");
let output = document.getElementById("output");

let pet = ["Breakout", "Civil War", "PETSCII ROBOTS"];
...
btn_pet.addEventListener("click", function () {
  var randomPET = pet[Math.floor(Math.random() * pet.length)];
  output.innerHTML = randomPET;
});
